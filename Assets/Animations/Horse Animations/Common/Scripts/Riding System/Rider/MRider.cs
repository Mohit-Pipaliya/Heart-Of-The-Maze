...
namespace MalbersAnimations.HAP
{
    ...
    public class MRider : MonoBehaviour, IAnimatorListener, IRider
    {
        ...
        [Tooltip("Gravity Direction." +
            "This is used to properly orient the Rider back to the Default Gravity when dismounting. E.g. When the Animal is on a Slope.")]
    ...
    {
        public readonly string version = "Riding System - HAP [4.5.0-pre]";
